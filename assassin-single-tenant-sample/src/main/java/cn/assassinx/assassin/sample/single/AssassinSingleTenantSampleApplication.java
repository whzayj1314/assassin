...
package cn.assassinx.assassin.sample.single;
...
public class AssassinSingleTenantSampleApplication {

	public static void main(String[] args) {
		SpringApplication.run(AssassinSingleTenantSampleApplication.class, args);
	}
