 ...
 * @author Barton
 */
public interface AssassinClientDetailsMapper extends BaseMapper<AssassinClientDetails> {
	 ...
	 * @return
	 */
	AssassinClientDetailsVO selectAssassinClientDetailsVOByClientId(String clientId);
}
